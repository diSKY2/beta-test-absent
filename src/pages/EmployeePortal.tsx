...
export default function EmployeePortal() {
  const [activeTab, setActiveTab] = useState<'home' | 'izin' | 'lembur' | 'jadwal' | 'laporan' | 'absen_anggota' | 'tukar_jadwal'>('home');
...
<div className="flex items-center justify-between">
  ...
  <span>Ambil Foto</span>
        ...
        {isLoggedIn && (
          <nav className="absolute bottom-0 left-0 w-full bg-white/95 backdrop-blur-md border-t border-slate-200/80 grid grid-cols-7 py-3 px-1 text-center z-40 select-none shadow-lg">
